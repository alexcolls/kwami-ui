...
export class Toast extends Component<ToastProps> {
    ...
    show(): void {
        ...
        // Dispatch event
        this.element?.dispatchEvent(new CustomEvent('toastchange', {
    ...
    setType(type: ToastType): void {
        ...
        this.toast.classList.remove('kwami-toast-info', 'kwami-toast-success', 'kwami-toast-warning', 'kwami-toast-error');
