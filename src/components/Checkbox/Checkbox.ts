...
export class Checkbox extends Component<CheckboxProps> {
    ...
    protected onHydrate(): void {
        ...
        checkboxes.forEach(checkbox => {
            this.addListener(checkbox, 'change', (e) => {
                ...
                // Dispatch event
                this.element?.dispatchEvent(new CustomEvent('checkboxchange', {
    ...
    selectAll(): void {
        const checkboxes = this.element?.querySelectorAll('.kwami-checkbox input') as NodeListOf<HTMLInputElement>;
