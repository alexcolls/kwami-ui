...
export class Selector extends Component<SelectorProps> {
            ...
            switch (key) {
                ...
                case 'ArrowDown':
                    ...
                    if (!this.isOpen) {
                        ...
                        const current = this.dropdown?.querySelector('.kwami-selector-option:focus') as HTMLElement;
    ...
    private toggleDropdown(open?: boolean): void {
        ...
        if (this.isOpen) {
            ...
            const selected = this.dropdown?.querySelector('.kwami-selector-option.selected') as HTMLElement;
    ...
    private selectOption(option: Element): void {
        ...
        // Dispatch event
        this.element?.dispatchEvent(new CustomEvent('selectorchange', {
